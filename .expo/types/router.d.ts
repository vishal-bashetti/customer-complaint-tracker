...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/loginScreen` | `/loginScreen` | `/(drawer)/(tabs)/complaint/` | `/complaint/` | `/(drawer)/(tabs)/complaint` | `/(drawer)/(tabs)/customer/` | `/customer/` | `/(drawer)/(tabs)/customer` | `/(drawer)/(tabs)/dashboard/` | `/dashboard/` | `/(drawer)/(tabs)/dashboard` | `/(drawer)/` | `/(drawer)` | `/App`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/${CatchAllRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/[...unmatched]`;
